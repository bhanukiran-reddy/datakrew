...
interface EventCtaButtonsProps {
  buttons: CtaButton[];
...
export default function EventCtaButtons({ buttons, wrapperClassName, isBanner, id }: EventCtaButtonsProps) {
  ...
  return (
    <>
      ...
      {showModal && (() => {
        let extractedAssetName = "Event Resource";
        if (selectedPdfUrl) {
